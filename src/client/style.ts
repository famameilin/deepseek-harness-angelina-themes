 ...
 * with her head clipped at the top. Sizing her against the window height and hanging her
 * off the lower-right corner holds that proportion at every aspect ratio, where a slack
 * percentage would drift with the window shape (the layer box carries a 16px bleed). */
